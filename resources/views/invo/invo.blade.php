            ...
            <div class="col-sm-3 pull-right">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="data" class="form-control date-picker"  placeholder="Invoice #" name="invoice_billing_date">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></div>
                        <input type="text" class="form-control date-picker"  id="billingDate" placeholder="Billing Date" name="invoice_due_date" autocomplete="off"  >
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
